...
#For all the functions below, I have copy pasted the code from Udacity's solution.py tab from the Sudoku lesson, because it is cleaner and more elegant. I could have pasted my own code which works as well, and I'm happy to resubmit with my own code if necessary 
